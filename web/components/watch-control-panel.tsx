        ...
        <CardContent className="space-y-4 pt-5">
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <label className="space-y-1.5 text-xs font-medium">
              ...
              <select
                ...
                value={config.room}
                onChange={(event) =>
                  setConfig({ ...config, room: event.target.value as "jade" })
                }
              >
          ...
          <label className="block space-y-1.5 text-xs font-medium">
            ...
            <Input
              ...
              onChange={(event) =>
                setConfig({ ...config, account_secret_ref: event.target.value })
              }
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setConfig({
                      ...config,
                      modes: checked
                        ? [...new Set([...config.modes, mode])]
                        : config.modes.filter((value) => value !== mode),
                    })
                  }
                />
                {mode === "east" ? "东风" : "东南"}
